...
@section('content')
<section class="pr-detail" data-name="Purchase Request Detail - ST (Rejected)">
    <div class="pr-detail__top">
        <div>
            <p class="pr-detail__ref">PR #00001</p>
            <h2 class="pr-detail__title">IE Department Request</h2>
        </div>
        <span class="pr-detail__status pr-detail__status--rejected">Rejected</span>
    </div>

    <div class="pr-detail__meta pr-detail__meta--four">
        ...
        <div class="pr-detail__meta-item">
            <span class="pr-detail__meta-label">Rejected By</span>
            <p class="pr-detail__meta-value">Kimtha Vay</p>
        </div>
        <div class="pr-detail__meta-item">
            <span class="pr-detail__meta-label">Rejected Date</span>
            <p class="pr-detail__meta-value">Jun 16, 2026</p>
        </div>
    </div>
    ...
    <div class="pr-detail__section">
        <h3 class="pr-detail__section-title">Admin Reason</h3>
        <p class="pr-detail__section-text">The item is too expensive</p>
    </div>
    ...
    <div class="pr-detail__actions">
        <a href="{{ route('staff.prs') }}" class="pr-detail__btn pr-detail__btn--muted">Back</a>
    </div>
</section>
@endsection
