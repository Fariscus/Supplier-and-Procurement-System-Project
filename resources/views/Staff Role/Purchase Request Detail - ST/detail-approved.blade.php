...
@section('content')
<section class="pr-detail" data-name="Purchase Request Detail - ST (Approved)">
    <div class="pr-detail__top">
        <div>
            <p class="pr-detail__ref">PR #00001</p>
            <h2 class="pr-detail__title">IE Department Request</h2>
        </div>
        <span class="pr-detail__status pr-detail__status--approved">Approved</span>
    </div>
    ...
    <div class="pr-detail__meta pr-detail__meta--four">
        ...
        <div class="pr-detail__meta-item">
            <span class="pr-detail__meta-label">Approved By</span>
            <p class="pr-detail__meta-value">Kimtha Vay</p>
        </div>
        <div class="pr-detail__meta-item">
            <span class="pr-detail__meta-label">Approved Date</span>
            <p class="pr-detail__meta-value">Jun 16, 2026</p>
        </div>
    </div>
