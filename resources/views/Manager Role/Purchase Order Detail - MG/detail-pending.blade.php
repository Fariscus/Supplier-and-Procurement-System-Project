...
@endphp
<section class="mgr-po-detail" data-name="Purchase Order Detail - MG (Pending)">
    <div class="mgr-po-detail__top">
        <div class="mgr-po-detail__heading">
            <h2 class="mgr-po-detail__title">PO-2051 · Golden Rice Co.</h2>
            <span class="mgr-po-detail__badge mgr-po-detail__badge--pending">Pending</span>
        </div>
        <div class="mgr-po-detail__actions">
            <a href="{{ route('manager.orders.detail.rejected') }}" class="mgr-po-detail__btn mgr-po-detail__btn--outline">
                Reject Order
            </a>
            <a href="{{ route('manager.orders.detail.approved') }}" class="mgr-po-detail__btn mgr-po-detail__btn--approve">
                <img src="{{ $img('check.svg') }}" alt="" width="15" height="15">
                Approve Order
            </a>
        </div>
    </div>
    ...
    <div class="mgr-po-detail__cards">
        <article class="mgr-po-detail__card">
            ...
            <a href="{{ route('manager.prs.review') }}" class="mgr-po-detail__card-link">View Request details</a>
        </article>
        <article class="mgr-po-detail__card">
        ...
        <article class="mgr-po-detail__card">
            ...
            <p class="mgr-po-detail__card-sub">Awaiting manager approval</p>
        </article>
    </div>
</section>
@endsection
