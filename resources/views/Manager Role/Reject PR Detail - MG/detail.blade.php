...
@section('title', 'Reject PR Detail - MG')
...
@push('styles')
    <link rel="stylesheet" href="{{ asset('Manager Role/Reject PR Detail - MG/css/detail.css') }}">
@endpush

@section('content')
<section class="mgr-prd" data-name="Reject PR Detail - MG" data-node-id="302:1837">
    <div class="mgr-prd__top">
        <div>
            <p class="mgr-prd__ref">PR #00001</p>
            <h2 class="mgr-prd__title">IE Department Request</h2>
        </div>
        <span class="mgr-prd__status mgr-prd__status--rejected">Rejected</span>
    </div>
    ...
    <div class="mgr-prd__meta">
        ...
        <div class="mgr-prd__meta-item">
            <span class="mgr-prd__meta-label">Rejected Date</span>
            <p class="mgr-prd__meta-value">Jun 16, 2026</p>
        </div>
    </div>
    ...
    <div class="mgr-prd__section">
        <h3 class="mgr-prd__section-title">Rejection Reason</h3>
        <p class="mgr-prd__section-text">Too expensive!</p>
    </div>
